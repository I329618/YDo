...
import com.sap.hybris.cart.impl.CommerceWebServicesCartFacade;
import com.sap.hybris.exceptions.InvalidPaymentInfoException;
import com.sap.hybris.exceptions.NoCheckoutCartException;
import com.sap.hybris.exceptions.UnsupportedDeliveryModeException;
import com.sap.hybris.exceptions.UnsupportedRequestException;
import com.sap.hybris.order.data.CartDataList;
import com.sap.hybris.order.data.OrderEntryDataList;
import com.sap.hybris.product.data.PromotionResultDataList;
import com.sap.hybris.request.support.impl.PaymentProviderRequestSupportedStrategy;
import com.sap.hybris.stock.CommerceStockFacade;
import com.sap.hybris.voucher.data.VoucherDataList;
...
public class CartsController extends BaseCommerceController
{
	...
	protected static CartModificationData mergeCartModificationData(final CartModificationData cmd1, final CartModificationData cmd2)
	{
